...
**Last Updated:** 2026-05-02 09:01:00
**Current Branch:** main
**Last Commit:** 97c7eb51 fix(collab): replace_activity dual root cause
...
```
97c7eb51 (HEAD -> main, origin/main, origin/HEAD) fix(collab): replace_activity dual root cause
032b889f fix(collab): broadcast Luna replace_activity to collaborators
aec6d545 fix(chat): compute activities text at send time, not render time
537e12b1 fix(chat): restructure context pipeline, structured itinerary as primary source
5b10b289 fix(chat): slot-structured itinerary context + slot discipline rules
2745a1d0 feat(collab): viewer-readonly Luna instruction + Stage 3 QA pass (Stage 3c)
7ebe7c8c fix(collab): confirm_day broadcast for editors and undo path
4cdefdc6 feat(collab): wire 'Accept this day' into broadcast pipeline
6db87dbd feat(collab): cross-awareness summary in Luna chat (Stage 3b)
