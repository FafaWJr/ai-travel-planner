...
const DESTINATIONS = [
  ...
  { name:'Patagonia',   country:'Argentina', tag:'Adventure', color:'#679AC1', img:'https://images.unsplash.com/photo-1569950044272-e796d9c96b5b?auto=format&fit=crop&w=800&q=80' },
  { name:'Marrakech',   country:'Morocco',   tag:'Discovery', color:'#FFBD59', img:'https://images.unsplash.com/photo-1539020140153-e479b8b1fc09?auto=format&fit=crop&w=800&q=80' },
  ...
  { name:'Bali',        country:'Indonesia', tag:'Wellness',  color:'#00447B', img:'https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=800&q=80' },
];
...
const TRIP_IDEAS = [
  ...
  { title:'Patagonia Adventure', sub:'Argentina & Chile', img:'https://images.unsplash.com/photo-1569950044272-e796d9c96b5b?auto=format&fit=crop&w=600&q=80', tags:['Adventure','Hiking'], dur:'12 days', bud:'Mid-range', q:'Plan a 12-day Patagonia adventure covering Argentina and Chile' },
  { title:'Morocco Highlights', sub:'Marrakech to Sahara', img:'https://images.unsplash.com/photo-1539020140153-e479b8b1fc09?auto=format&fit=crop&w=600&q=80', tags:['Culture','Desert'], dur:'8 days', bud:'Budget', q:'Plan an 8-day Morocco trip from Marrakech to the Sahara' },
  { title:'Bali Wellness Retreat', sub:'Ubud & Seminyak', img:'https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=600&q=80', tags:['Wellness','Beach'], dur:'10 days', bud:'Mid-range', q:'Plan a 10-day Bali wellness retreat in Ubud and Seminyak' },
