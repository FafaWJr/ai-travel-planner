...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Sundowners at a beach bar, feet in the sand',   value: 'eve_sundowner', icon: 'Waves' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Beautiful beaches and clear ocean',      value: 'must_beach',   icon: 'Waves' },
...
const QUIZ_RESULTS: QuizPersona[] = [
  ...
  },
  {
    id: 'beach_bum',
    name: 'The Sun Seeker',
    travelStyle: 'Sun, Sand and Good Vibes',
    personaImage: '/quiz/luna-personas/the-sun-seeker.png',
    description: 'Your perfect day starts with bare feet on warm sand, peaks at a beach bar with something cold in hand, and ends watching the horizon turn gold. The beach is not just a destination. It is a lifestyle.',
    travelProfile: 'Laid-back but sociable. You gravitate toward places where beach culture is the whole identity. You have a sixth sense for finding the best beach bar on any coast and you always know where the vibe is right.',
    tripStyle: 'Beachfront accommodation as close to the water as possible, beach club days, cocktail hours at sunset, social evenings that start easy and end when the mood says so, and at least one stretch of sand that makes you stop scrolling.',
    askLuna: [
      'What is the best beach bar at my destination and what time should I arrive?',
      'Find me the most beautiful beach near my hotel that locals actually use.',
      'Add a beach club day to my itinerary with food, cocktails and ocean access.',
    ],
    destinations: ['Bali, Indonesia', 'Mykonos, Greece', 'Tulum, Mexico', 'Phuket, Thailand', 'Ibiza, Spain', 'Zanzibar, Tanzania', 'Koh Samui, Thailand', 'Amalfi Coast, Italy'],
  },
];
...
function calculatePersona(allSelectedValues: string[]): QuizPersona {
  ...
  const scoreMap: Record<string, Record<string, number>> = {
    ex_beach:     { relaxer: 4, romantic: 2, photographer: 1, beach_bum: 4 },
    ex_culture:   { culture: 4, explorer: 2, foodie: 1 },
    ex_party:     { party: 5, festival: 2, beach_bum: 2 },
    ...
    ex_luxury:    { luxury: 5, romantic: 2, relaxer: 1, beach_bum: 1 },
    ex_romance:   { romantic: 5, relaxer: 2, luxury: 1, beach_bum: 1 },
    ex_family:    { family: 5 },
    ...
    eve_dining:   { foodie: 4, luxury: 3, romantic: 2, beach_bum: 1 },
    eve_club:     { party: 5, festival: 2, solo: 1, beach_bum: 2 },
    ...
    eve_sundowner: { beach_bum: 5, relaxer: 2, romantic: 1 },

    who_solo:    { solo: 5, explorer: 2, adventurer: 2 },
    who_partner: { romantic: 5, luxury: 2, relaxer: 2, beach_bum: 2 },
    who_group:   { party: 3, festival: 3, explorer: 2, solo: 1, beach_bum: 2 },
    who_family:  { family: 5 },
    who_luxury:  { luxury: 4, romantic: 3 },
    who_open:    { solo: 4, party: 2, adventurer: 1, beach_bum: 1 },

    must_party:   { party: 5, festival: 3, beach_bum: 2 },
    must_beach:   { beach_bum: 5, relaxer: 2, romantic: 1 },
    must_photo:   { photographer: 5 },
    must_food:    { foodie: 5, luxury: 2 },
    must_nature:  { adventurer: 4, explorer: 2, relaxer: 1 },
    must_peace:   { relaxer: 4, romantic: 2, photographer: 1, beach_bum: 1 },
    must_luxury:  { luxury: 5, romantic: 2, beach_bum: 1 },
    ...
    style_spontaneous: { party: 3, solo: 3, adventurer: 2, explorer: 2, beach_bum: 1 },
    style_balanced:    { relaxer: 2, explorer: 2, foodie: 2, photographer: 1, beach_bum: 2 },
    ...
    budget_mid:        { relaxer: 1, foodie: 1, culture: 1, photographer: 1, family: 1, beach_bum: 1 },
    budget_comfort:    { luxury: 2, relaxer: 2, romantic: 2, foodie: 1, beach_bum: 2 },
    budget_luxury:     { luxury: 5, romantic: 3, relaxer: 2, beach_bum: 1 },

    dur_weekend:   { romantic: 2, party: 2, festival: 2, beach_bum: 1 },
    dur_week:      { relaxer: 2, foodie: 2, culture: 2, photographer: 1, beach_bum: 2 },
    dur_two_weeks: { explorer: 3, adventurer: 3, relaxer: 2, culture: 2, beach_bum: 2 },
